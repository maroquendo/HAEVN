...
export const HaevnLogo = ({ className = 'h-8' }: { className?: string }) => (
    <svg className={className} viewBox="0 0 140 28" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <text x="50%" y="22" textAnchor="middle" fontFamily="Arial, sans-serif" fontSize="28" fontWeight="bold" letterSpacing="2">
            HAEVN
        </text>
    </svg>
);
...
export const LoveIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" />
  </svg>
);

export const DislikeIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
...
export const SubscriptionsIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 17l-4-4 4-4" />
    </svg>
);

export const WishlistIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.25278C12 6.25278 14.893 3 17.5 3C21.467 3 22.016 7.375 19.5 9.5C17 11.625 12 17.7472 12 17.7472" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.25278C12 6.25278 9.107 3 6.5 3C2.533 3 1.984 7.375 4.5 9.5C7 11.625 12 17.7472 12 17.7472" />
