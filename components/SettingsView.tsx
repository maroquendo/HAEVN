...
interface SettingsViewProps {
  ...
  family: Family;
  onAddMember: (name: string, role: 'child' | 'parent') => User | null;
                        ...
                        <div className="flex items-center space-x-4">
                            <div className="flex-1">
                                ...
                                <input 
                                    ...
                                    className="mt-1 block w-full p-2 bg-gray-100 dark:bg-gray-700 border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                                />
                            </div>
                            <div className="flex-1">
